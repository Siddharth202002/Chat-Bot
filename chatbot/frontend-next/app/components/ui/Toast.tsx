          ...
          return (
            <div
              ...
              className={cn(
                ...
                "glass-strong overflow-hidden rounded-2xl py-3 pl-4 pr-2",
                "shadow-e3"
              )}
            >
              ...
              <button
                ...
                className="-mt-0.5 shrink-0 rounded-full p-1 text-fg-subtle transition-colors hover:bg-hover hover:text-fg"
              >
